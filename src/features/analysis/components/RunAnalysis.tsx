...
import { useStockStore } from "../../explore/store/useStockStore";

type RunAnalysisProps = {
  selectedStock: string;
};

const RunAnalysis: React.FC<RunAnalysisProps> = ({ selectedStock }) => {
  const setRunAnalysis = useStockStore((state) => state.setRunAnalysis);
