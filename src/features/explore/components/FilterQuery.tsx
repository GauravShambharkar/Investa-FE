...
const FilterQuery: React.FC<FilterQueryProps> = ({ item, index }) => {
  const openIndex = useStockStore((state) => state.openIndex);
  const toggleDetail = useStockStore((state) => state.toggleDetail);
